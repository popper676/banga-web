...
export const TRANSACTIONS: Transaction[] = [
  ...
  },
  {
    ...
    notice: "Photo booth was under maintenance, so the booth session was refunded and the food was not.",
    ...
    events: [
      ...
      { label: "Partial refund submitted", at: "18 Sep 2026, 13:02:00", actor: "Finance", note: "RM2.50 · photo booth session" },
...
export const REFUND_REQUESTS: RefundRequest[] = [
  ...
  },
  {
    ...
    amount: 250,
    orderTotal: 1579,
    reason: "Photo booth under maintenance — session refunded, food kept",
...
export const PROMO_META: Record<string, PromoMeta> = {
  ...
  "promo-booth": {
    ...
    fulfilment: "all",
    active: false,
    usageByWeek: [12, 18, 21, 17, 16, 19, 20, 15],
    revenue: 246800,
  },
};
